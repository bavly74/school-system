                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($books as $book)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('library.downloadAttachment',$book->file_name)}}" title="تحميل الكتاب" class="btn btn-warning btn-sm" role="button" aria-pressed="true"><i class="fa solid fa-download"></i></a>
                                        ...
                                        @include('pages.myLibrary.delete')
                                        @endforeach
                                    </table>
                                </div>
                            </div>
